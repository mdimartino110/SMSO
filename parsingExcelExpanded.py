...
# Python Script to take in a student data dump from my school app from a list
# made by Michael DiMartino, and spit out a spreadsheet organized to submit to
# New York State.
# Version: 2.0
# Major Update: Added Regents Sorting
